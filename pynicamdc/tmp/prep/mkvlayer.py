...
layer = mkvlayer(num_of_layer = 10, layer_type = 'ULLRICH14', ztop = 1.E4, infname = 'infile', outfname = 'outfile') 
layer.generate_layers()

#(self, num_of_layer = 10, layer_type = 'ULLRICH14', ztop = 1.E4, infname = 'infile', outfname = 'outfile'):

#layer = mkvlayer(self, num_of_layer = 10, layer_type = 'ULLRICH14', ztop = 1.E4, infname = 'infile', outfname = 'outfile')
#layer.generate_layers()
